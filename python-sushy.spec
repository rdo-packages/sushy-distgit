...
%changelog
* Thu Apr 28 2022 RDO <dev@lists.rdoproject.org> 3.4.6-1
- Update to 3.4.6

* Fri Feb 04 2022 RDO <dev@lists.rdoproject.org> 3.4.5-1
- Update to 3.4.5

* Tue Jun 15 2021 RDO <dev@lists.rdoproject.org> 3.4.4-1
- Update to 3.4.4

* Mon Apr 19 2021 RDO <dev@lists.rdoproject.org> 3.4.3-1
- Update to 3.4.3

* Mon Feb 01 2021 RDO <dev@lists.rdoproject.org> 3.4.2-1
- Update to 3.4.2

* Wed Oct 21 2020 Joel Capitao <jcapitao@redhat.com> 3.4.1-2
- Enable sources tarball validation using GPG signature.

* Fri Sep 25 2020 RDO <dev@lists.rdoproject.org> 3.4.1-1
- Update to 3.4.1
